...
* [`src/alfred/bootstrap/gate_factory.py`](../../src/alfred/bootstrap/gate_factory.py) — the production-side `_make_in_process_backend` + `_make_no_op_audit_sink` stub builders the helper deliberately duplicates.
