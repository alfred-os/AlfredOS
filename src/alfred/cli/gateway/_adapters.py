...
Exit-code contract (mirrors the deleted ``alfred discord verify`` 0/1/2/3 so operator
scripts can branch the same way):
...
# Exit codes (the deleted ``alfred discord verify`` 0/1/2/3 contract).
